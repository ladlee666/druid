...
public class MagicSchemaStatVisitor extends SQLASTVisitorAdapter {
    ...
    public MagicSchemaStatVisitor() {
        this((DbType) null);
    }

    public MagicSchemaStatVisitor(SchemaRepository repository) {
        if (repository != null) {
    ...
    public MagicSchemaStatVisitor(DbType dbType) {
        this(new SchemaRepository(dbType), new ArrayList<Object>());
        this.dbType = dbType;
    }

    public MagicSchemaStatVisitor(List<Object> parameters) {
        this((DbType) null, parameters);
    }

    public MagicSchemaStatVisitor(DbType dbType, List<Object> parameters) {
        this(new SchemaRepository(dbType), parameters);
        this.parameters = parameters;
    }

    public MagicSchemaStatVisitor(SchemaRepository repository, List<Object> parameters) {
        this.repository = repository;
        this.parameters = parameters;
        if (repository != null) {
    ...
    protected Column addColumn(String tableName, String columnName, SQLExpr columnExpr) {
        Column c = new Column(tableName, columnName, dbType, columnExpr);
    ...
    protected Column addColumn(SQLName table, String columnName, SQLExpr columnExpr) {
        String tableName;
        ...
        if (column == null && columnName != null) {
            column = new Column(tableName, columnName, columnHashCode64, columnExpr);
    ...
    protected Column getColumn(SQLExpr expr) {
        ...
        if (expr instanceof SQLPropertyExpr) {
            ...
            if (owner instanceof SQLName) {
                ...
                if (table != null) {
                    ...
                    if (columnObj == null) {
                        columnObj = new Column(tableName, column, columnHashCode64, original);
                        if (!(resolvedOwnerObject instanceof SQLSubqueryTableSource
        ...
        if (expr instanceof SQLIdentifierExpr) {
            ...
            if (table != null) {
                ...
                return new Column(table.toString(), column, columnHashCode64, original);
            }
...
//        }
        ...
        if (tableSource instanceof SQLExprTableSource) {
            ...
            if (expr instanceof SQLIdentifierExpr) {
                ...
                if (schemaObject != null
                    ...
                    if (columnDef == null) {
                        column = addColumn("UNKNOWN", ident, null);
                    }
                }
        ...
        if (createStmt != null
            ...
            for (SQLTableElement e : createStmt.getTableElementList()) {
                if (e instanceof SQLColumnDefinition) {
                    ...
                    Column column = addColumn(tableName, columnName.toString(), columnName);
            ...
            Column column = addColumn(expr, "*", null);
            if (isParentSelectItem(x.getParent())) {
                column.setSelec(true);
            }
        }
    ...
    public Map<Long, Column> getColumnPairs() {
        return columns;
    }
    ...
    public boolean visit(SQLColumnDefinition x) {
        ...
        Column column = addColumn(tableName, columnName, x.getName());
    ...
    public boolean visit(SQLAlterTableAddColumn x) {
        ...
        for (SQLColumnDefinition column : x.getColumns()) {
            ...
            addColumn(stmt.getName(), columnName, column.getName());
        }
        return false;
    }
    ...
    public boolean visit(SQLCreateIndexStatement x) {
        ...
        for (SQLSelectOrderByItem item : x.getItems()) {
            ...
            if (expr instanceof SQLIdentifierExpr) {
                ...
                addColumn(table, columnName, identExpr);
            } else if (expr instanceof SQLMethodInvokeExpr) {
                SQLMethodInvokeExpr methodInvokeExpr = (SQLMethodInvokeExpr) expr;
    ...
    public boolean visit(SQLForeignKeyImpl x) {
        ...
        for (SQLName column : x.getReferencedColumns()) {
            ...
            addColumn(table, columnName, column);
        }
    ...
    public boolean visit(SQLCopyFromStatement x) {
        ...
        if (table != null) {
            ...
            for (SQLName column : x.getColumns()) {
                addColumn(table.getName(), column.getSimpleName(), column);
            }
        }
