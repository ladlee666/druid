...
import com.alibaba.druid.sql.visitor.MagicSchemaStatVisitor;
...
public class MagicOracleSchemaStatVisitor extends MagicSchemaStatVisitor implements OracleASTVisitor {
    public MagicOracleSchemaStatVisitor() {
        this(new ArrayList<Object>());
    }

    public MagicOracleSchemaStatVisitor(SchemaRepository repository) {
        super(repository);
    }

    public MagicOracleSchemaStatVisitor(List<Object> parameters) {
...
//        }
    ...
    public boolean visit(OracleAlterTableModify x) {
        ...
        for (SQLColumnDefinition column : x.getColumns()) {
            ...
            addColumn(tableName, columnName.toString(), columnName);
